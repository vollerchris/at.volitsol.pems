...
import at.volitsol.pems.domain.LocationDataOnDemand;
...
privileged aspect LocationIntegrationTest_Roo_IntegrationTest {
    ...
    public void LocationIntegrationTest.testCountLocations() {
        ...
        long count = at.volitsol.pems.domain.Location.countLocations();
    ...
    public void LocationIntegrationTest.testFindLocation() {
        ...
        at.volitsol.pems.domain.Location obj = at.volitsol.pems.domain.Location.findLocation(id);
    ...
    public void LocationIntegrationTest.testFindAllLocations() {
        ...
        java.util.List<at.volitsol.pems.domain.Location> result = at.volitsol.pems.domain.Location.findAllLocations();
    ...
    public void LocationIntegrationTest.testFindLocationEntries() {
        ...
        java.util.List<at.volitsol.pems.domain.Location> result = at.volitsol.pems.domain.Location.findLocationEntries(0, (int)count);
    ...
    public void LocationIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Location' failed to initialize correctly", dod.getRandomLocation());
        at.volitsol.pems.domain.Location obj = dod.getNewTransientLocation(Integer.MAX_VALUE);
    ...
    public void LocationIntegrationTest.testRemove() {
        ...
        org.junit.Assert.assertNotNull("Find method for 'Location' illegally returned null for id '" + id + "'", obj);
        obj.remove();
        org.junit.Assert.assertNull("Failed to remove 'Location' with identifier '" + id + "'", at.volitsol.pems.domain.Location.findLocation(id));
    }
